...
namespace Presentation.Controllers
{
    public class CategoryController : Controller
    {
        ...
        public CategoryController(SeriesCatalogueContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Genre,Id")] CategoryModel categoryModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Genre,Id")] CategoryModel categoryModel)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SeriesCatalogueContext.CategoryModel'  is null.");
            }
            var categoryModel = await _context.CategoryModel.FindAsync(id);
            if (categoryModel != null)
            {
